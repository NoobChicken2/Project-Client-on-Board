        ...
        <div class="modal-dialog" role="document" in:fly={{ y: -50, duration: 300 }} out:fly={{ y: -50, duration: 300, easing: quintOut }}>
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="bi bi-x-circle" data-dismiss="modal" aria-label="Close" on:click={() => modalClose('close')}>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" on:click={() => modalClose('Delete')}>Delete</button>
                </div>
            </div>
        </div>
    </div>
